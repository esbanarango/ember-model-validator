...
describe('ModelValidatorMixin', function() {
  ...
  describeModel(
    'fake-model',
    'Fake model with simple validations',
    {
    ...
    function() {
        ...
        it('runs remaining validations when optional field is not blank', function() {
          ...
          expect(
            model
              ...
              .mapBy('message')[0][0]
          ).to.equal(Messages.numericalityMessage);
          expect(
            model
              .get('errors')
              .errorsFor('anOptionalNumber')
              .mapBy('message')[1][0]
          ).to.equal(Messages.numericalityOnlyIntegerMessage);
        });
      });
      ...
      it('validates the format of the attributes set on `validations.format`', function() {
        ...
        expect(
          model
            .get('errors')
            .errorsFor('legacyCode')
            .mapBy('message')[0][0]
        ).to.equal(Messages.formatMessage);
      });
      ...
      it('validates the acceptance of the attributes set on `validations.acceptance`', function() {
        ...
        expect(
          model
            .get('errors')
            .errorsFor('acceptConditions')
            .mapBy('message')[0][0]
        ).to.equal(Messages.acceptanceMessage);
      });
      ...
      it('validates the matching of the attributes set on `validations.password`', function() {
        ...
        expect(
          model
            ...
            .errorsFor('password')
            .mapBy('message')[0][0]
        ).to.equal(formater.formatMessage(Messages.matchMessage, context));
      });
      ...
      it('validates the absence of the attributes set on `validations.absence`', function() {
        ...
        expect(
          model
            ...
            .errorsFor('login')
            .mapBy('message')[0][0]
        ).to.equal(Messages.absenceMessage);
      });
      ...
      describe('Postalcode validation', function() {
        it('validates the zip code being invalid in the US', function() {
          ...
          expect(
            model
              .get('errors')
              .errorsFor('postalCodeUS')
              .mapBy('message')[0][0]
          ).to.equal(Messages.zipCodeMessage);
        });
      ...
      it('validates the color format of the attributes set on `validations.color`', function() {
        ...
        expect(
          model
            .get('errors')
            .errorsFor('favoriteColor')
            .mapBy('message')[0][0]
        ).to.equal(Messages.colorMessage);
      ...
      it('validates the subdomain format of the attributes set on `validations.subdomain`', function() {
        ...
        expect(
          model
            .get('errors')
            .errorsFor('mySubdomain')
            .mapBy('message')[0][0]
        ).to.equal(Messages.subdomainMessage);
      ...
      it('validates the inclusion of the attributes set on `validations.inclusion`', function() {
        ...
        expect(
          model
            ...
            .errorsFor('name')
            .mapBy('message')[0][0]
        ).to.equal(Messages.inclusionMessage);
      ...
      it('validates the exclusion of the attributes set on `validations.exclusion`', function() {
        ...
        expect(
          model
            .get('errors')
            .errorsFor('secondName')
            .mapBy('message')[0][0]
        ).to.equal(Messages.exclusionMessage);
            ...
            run(function() {
              ...
              expect(
                model
                  ...
                  .mapBy('message')[0][0]
              ).to.equal(formater.formatMessage(Messages.numericalityGreaterThanMessage, context));
            });
          });
        });
            ...
            run(function() {
              ...
              expect(
                model
                  ...
                  .mapBy('message')[0][0]
              ).to.equal(formater.formatMessage(Messages.numericalityGreaterThanOrEqualToMessage, context));
            });
          });
        });
          ...
          it('validates that the number is `greater than or equal` to the specified value', function() {
            ...
            run(function() {
              ...
              expect(
                model
                  .get('errors')
                  .errorsFor('aTenNumber')
                  .mapBy('message')[0][0]
              ).to.equal(formater.formatMessage(Messages.numericalityEqualToMessage, context));
            });
          });
        });
            ...
            run(function() {
              ...
              expect(
                model
                  ...
                  .mapBy('message')[0][0]
              ).to.equal(formater.formatMessage(Messages.numericalityLessThanMessage, context));
            });
          });
        });
            ...
            run(function() {
              ...
              expect(
                model
                  ...
                  .mapBy('message')[0][0]
              ).to.equal(formater.formatMessage(Messages.numericalityLessThanOrEqualToMessage, context));
            });
          });
        });
          ...
          it('validates that the number is `odd`', function() {
            ...
            run(function() {
              ...
              expect(
                model
                  .get('errors')
                  .errorsFor('anOddNumber')
                  .mapBy('message')[0][0]
              ).to.equal(Messages.numericalityOddMessage);
            });
          });
        });
          ...
          it('validates that the number is `even`', function() {
            ...
            run(function() {
              ...
              expect(
                model
                  .get('errors')
                  .errorsFor('anEvenNumber')
                  .mapBy('message')[0][0]
              ).to.equal(Messages.numericalityEvenMessage);
            });
          });
        });
      });
        ...
        it('validates that the date is `before` the specified value', function() {
          ...
          run(function() {
            ...
            expect(
              model
                .get('errors')
                .errorsFor('dateBefore2015')
                .mapBy('message')[0][0]
            ).to.equal(formater.formatMessage(Messages.dateBeforeMessage, context));
          });
        });
        it('validates that the date is `after` the specified value', function() {
          ...
          run(function() {
            ...
            expect(
              model
                .get('errors')
                .errorsFor('dateAfter2014')
                .mapBy('message')[0][0]
            ).to.equal(formater.formatMessage(Messages.dateAfterMessage, context));
          });
        });
      });
              ...
              run(function() {
                ...
                expect(
                  model
                    ...
                    .mapBy('message')[0][0]
                ).to.equal(formater.formatMessage(Messages.wrongLengthMessage, context));
              });
            });
          });
              ...
              run(function() {
                ...
                expect(
                  model
                    ...
                    .mapBy('message')[0][0]
                ).to.equal('this is not the length of a chuncalucho');
              });
            });
          });
              ...
              run(function() {
                ...
                expect(
                  model
                    ...
                    .mapBy('message')[0][0]
                ).to.equal('please it has to be minimum 2 come on man!!');
              });
            });
          });
        });
              ...
              run(function() {
                ...
                expect(
                  model
                    ...
                    .errorsFor('nsaNumber')
                    .mapBy('message')[0][0]
                ).to.equal(formater.formatMessage(Messages.tooShortMessage, context));
              });
            });
          });
              ...
              run(function() {
                ...
                expect(
                  model
                    ...
                    .errorsFor('hugeName')
                    .mapBy('message')[0][0]
                ).to.equal(formater.formatMessage(Messages.tooLongMessage, context));
              });
            });
          });
        });
        ...
        it('validates the presence of the attributes set on `validations.presence` and use the correct message', function() {
          ...
          run(function() {
            ...
            expect(
              model
                .get('errors')
                .errorsFor('bussinessEmail')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.bussinessEmail.presence.message);
          });
        });
          ...
          run(function() {
            ...
            expect(
              model
                ...
                .errorsFor('lotteryNumber')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.lotteryNumber.custom.message);
          });
        });
          ...
          run(function() {
            ...
            expect(
              model
                ...
                .errorsFor('bussinessEmail')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.bussinessEmail.email.message);
          });
        });
          ...
          run(function() {
            ...
            expect(
              model
                ...
                .errorsFor('favoriteColor')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.favoriteColor.color.message);
          });
        });
          ...
          run(function() {
            ...
            expect(
              model
                ...
                .errorsFor('mySubdomain')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.mySubdomain.subdomain.message);
          });
        });
        ...
        it('validates the format of the attributes set on `validations.format` and use the correct message', function() {
          ...
          run(function() {
            ...
            expect(
              model
                .get('errors')
                .errorsFor('mainstreamCode')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.mainstreamCode.format.message);
          });
        });
          ...
          run(function() {
            ...
            expect(
              model
                ...
                .errorsFor('name')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.name.inclusion.message);
          });
        });
          ...
          run(function() {
            ...
            expect(
              model
                ...
                .errorsFor('secondName')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.secondName.exclusion.message);
          });
        });
        ...
        it('validates the numericality of the attributes set on `validations.numericality`', function() {
          ...
          run(function() {
            ...
            expect(
              model
                .get('errors')
                .errorsFor('alibabaNumber')
                .mapBy('message')[0][0]
            ).to.equal(model.validations.alibabaNumber.numericality.message);
          });
        });
            ...
            it('set error message using the function return', function() {
              ...
              run(function() {
                ...
                expect(
                  ...
                  `otherCustomValidation must have exactly 5 digits, value ${model.get(
