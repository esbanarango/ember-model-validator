...
import PostalCodesRegex from '../postal-codes-regex.js';
import MessagesEn from '../messages/en.js';
import MessagesAr from '../messages/ar.js';
import MessagesFr from '../messages/fr.js';
import MessagesEs from '../messages/es.js';
import MessagesPtbr from '../messages/pt-br.js';
import MessagesUk from '../messages/uk.js';
import MessagesHu from '../messages/hu.js';
import MessagesSr from '../messages/sr.js';
import MessagesSrCyrl from '../messages/sr-cyrl.js';
...
function coreValidator(constructor) {
  return class CoreValidator extends constructor {
    ...
    _rangeLength(stringLength, property, validation) {
      ...
      } else if (typeOf(validation.length.minimum) === 'object' && Object.prototype.hasOwnProperty.call(validation.length.minimum, 'value')) {
        minimum = validation.length.minimum.value;
      }
      if (typeOf(validation.length.maximum) === 'number') {
        maximum = validation.length.maximum;
      } else if (typeOf(validation.length.maximum) === 'object' && Object.prototype.hasOwnProperty.call(validation.length.maximum, 'value')) {
...
export { coreValidator as default };
